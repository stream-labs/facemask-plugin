...
namespace smll {
	...
	Config::Config()
		...
		AddParam(CONFIG_FLOAT_SMOOTHING_FACTOR, 0.666, 0.0, 500.0, 0.1);
		AddParam(CONFIG_FLOAT_PS_TR, 0.666, 0.0, 30.0, 0.1);
		AddParam(CONFIG_FLOAT_ANGLE, 0.666, 0.0, 20.0, 0.1);
