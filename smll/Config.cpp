...
namespace smll {
	...
	Config::Config()
		...
		AddParam(CONFIG_FLOAT_PROCCESS_NOISE, 0.000017, 0.0, 1.0, 1e-5);
		AddParam(CONFIG_FLOAT_MEASURE_NOISE, 0.00002, 0.0, 1.0, 1e-5);
		...
		AddParam(CONFIG_INT_FACE_DETECT_FREQUENCY, 0, 0, 600, 1);
