...
public:
    ...
    {
        IppStatus status = ::iwiAddC(rhs, this, this, NULL, NULL);
        OWN_ERROR_CHECK_THROW_ONLY(status);
        return *this;
    }
    ...
    inline IwiImage& operator-=(const IwValueFloat &rhs)
    {
        IppStatus status = ::iwiSubC(rhs, this, this, NULL, NULL);
        OWN_ERROR_CHECK_THROW_ONLY(status);
        return *this;
    }
    ...
    inline IwiImage& operator*=(const IwValueFloat &rhs)
    {
        IppStatus status = ::iwiMulC(rhs, this, this, NULL, NULL);
        OWN_ERROR_CHECK_THROW_ONLY(status);
        return *this;
    }
    ...
    inline IwiImage& operator/=(const IwValueFloat &rhs)
    {
        IppStatus status = ::iwiDivC(rhs, this, this, NULL, NULL);
        OWN_ERROR_CHECK_THROW_ONLY(status);
        return *this;
    }
